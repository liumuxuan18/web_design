const legalVideoFormats = [
  ...
  $(function(){
    $("#inputFile").on("change",function(e){
      $("table").empty();  //清空所有TABLE元素 避免下次進來有重複之前的檔案
      $("table").append("<tr><th>檢查項目</th><th>需求規格</th><th>檢查結果</th><th>是否通過</th></tr>");//把標題加回來
      // debugger;
  ...
  function dragenter(){
    $("#dropbox").css("bodeer","5px solid blue");
    $("#dropbox").text("Drop it!");
  }
  
  function dragleave() {
    $("#dropbox").css("bodeer", "5px dashed black");
